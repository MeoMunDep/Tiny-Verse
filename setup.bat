@echo off
title Tiny Verse Bot by @MeoMunDep
color 0A
...
cls
echo =================================================================
echo    Tiny Verse BOT SETUP AND RUN SCRIPT by @MeoMunDep
echo =================================================================
echo.
...
if exist "..\node_modules" (
    ...
    npm install axios meo-forkcy-colors meo-forkcy-utils meo-forkcy-proxy
    cd %~dp0
) else (
